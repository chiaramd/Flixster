...
* [X] List anything else that you can get done to improve the app functionality!
  * Loads 20 additional movies each time user scrolls to bottom
  * YouTubePlayerView embedded in details page
  * Details view contains runtime information obtained via an additional API call
...
<img src='Flixter_GIF_2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
